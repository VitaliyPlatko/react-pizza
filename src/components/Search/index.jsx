...
const Search = ({serchValue, setSearchValue}) => {
    return (
        <div className={styles.root}>
            ...
            />
            {serchValue && <img onClick={()=>setSearchValue('')} className={styles.clearIcon} src='close.png' alt='close'></img>}
        </div>
    )
}
